...
Mac App Store를 거치지 않고 Developer ID로 서명·공증한 앱을 사내 구성원에게 배포합니다.
...
사내용 Mac 앱을 나눠주는 방법은 보통 이렇습니다. 누군가 로컬에서 빌드하고, 서명하고,
공증을 기다리고, 결과물을 사내 스토리지나 메신저로 올립니다. 받는 사람은 그게 최신인지,
