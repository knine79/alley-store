...
열면 오류가 납니다. 일회성 명령을 돌릴 수 없는 배포 환경이라면 부팅할 때 돌리게
켤 수 있습니다 ([운영 가이드](docs/operations.md#migrate-를-돌릴-수-없는-환경이라면)).
...
| [Sparkle 서명키](docs/sparkle.md) | appcast 로 스스로 업데이트하는 앱을 배포할 때만. **스토어 앱 자신은 Sparkle 을 쓰지 않습니다** |
